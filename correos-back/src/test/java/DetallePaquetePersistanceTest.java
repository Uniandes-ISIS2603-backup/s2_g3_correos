...
public class DetallePaquetePersistanceTest {
    ...
    public void createDetalleTest() {
        ...
        DetallePaqueteEntity entity = em.find(DetallePaqueteEntity.class, result.getIdDetalle());
    ...
    public void getDetalleTest() {
        ...
        DetallePaqueteEntity newEntity = detallePaquetePersistence.find(entity.getIdDetalle());
    ...
    public void deleteDetalleTest() {
        DetallePaqueteEntity entity = data.get(0);
        detallePaquetePersistence.delete(entity.getIdDetalle());
        DetallePaqueteEntity deleted = em.find(DetallePaqueteEntity.class, entity.getIdDetalle());
